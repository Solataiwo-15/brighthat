...
export default function HeroSection() {
  return (
    <section className="relative w-full pt-12 pb-0 lg:pt-5 lg:pb-0 overflow-hidden">
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-4 items-center">
          <div className="flex flex-col items-start max-w-2xl z-10">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-[67px] font-bold leading-[1.1] text-brand-black mb-4">
              Borderless, <br className="hidden lg:block" />
              <span className="text-brand-orange">outcome-focused</span>{" "}
          ...
          <div className="relative flex justify-center lg:justify-end">
            <div className="relative w-[85%] sm:w-[70%] lg:w-full max-w-[600px] aspect-square">
              <Image
                src="/hero-full.png"
